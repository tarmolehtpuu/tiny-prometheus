...
Supports exporting metrics in Prometheus format (version 0.0.4). Also planning to add some simple query methods in
a future version.
...
dependencies {
    implementation("ee.moo:tiny-prometheus:0.0.3")
}
```
